          ...
          <div className="project-item active" id="project-wechat-analysis">
            <div className="project-content">
              ...
              <div className="project-detail1">
                <p className="project-active-detail1">
                  Calculate sentimental score by{" "}
                  <span style={{ color: "white" }}>SnowNLP</span> to analyze
                  emotion<br></br>
                ...
                <div
                  ...
                  id="project-image-container1"
                >
                  <div className="project-image" id="project-image1">
                    <img
                      src={"/image/sentiment_score_daily.png"}
                      alt="sentiment score daily"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="project-item">
            <div className="project-content">
              ...
              <div className="project-detail3">
                <p className="project-active-detail3">
                  Use{" "}
                  <span style={{ color: "white" }}>CNN, LSTM, and ARIMA </span>
                  to predict Tesla stock prices.
                  <br></br>
                ...
                <div
                  className="project-image-container"
                  id="project-image-container3"
                >
                  <div className="project-image" id="project-image3">
                    <img
                      src={"/image/price.png"}
                      alt="TASLA price prediction"
                    />
                  </div>
                </div>
              </div>
